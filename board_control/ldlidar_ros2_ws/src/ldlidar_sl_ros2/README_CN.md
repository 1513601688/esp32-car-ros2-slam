...
mkdir -p esp32_car_project/ldlidar_ros2_ws/src

cd esp32_car_project/ldlidar_ros2_ws/src
...
- 为了重新打开终端后，永久不用执行上述添加环境变量的命令，可以进行如下操作.
  ...
  ```bash
  echo "source ~/esp32_car_project/ldlidar_ros2_ws/install/local_setup.bash" >> ~/.bashrc
